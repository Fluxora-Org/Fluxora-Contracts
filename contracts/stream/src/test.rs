...
fn test_multiple_streams_independent() {
    ...
    let id1 = ctx
        .client()
        .create_stream(&ctx.sender, &ctx.recipient, &200, &2, &0, &0, &100 &0_i128,);
...
fn test_create_stream_cliff_equals_start() {
    ...
    let stream_id = ctx.client().create_stream(
        ...
        &1_i128,
        &100u64,
        &100u64, // cliff == start (valid &0_i128,)
        &1100u64,
    );
...
fn test_create_stream_cliff_equals_end() {
    ...
    let stream_id = ctx.client().create_stream(
        ...
        &1_i128,
        &0u64,
        &1000u64, // cliff == end (valid &0_i128,)
        &1000u64,
    );
...
fn test_create_streams_batch_success() {
    ...
    let params1 = CreateStreamParams {
        ...
        start_time: 0,
        cliff_time: 0,
        end_time: 1000, min_withdrawal: 0,
    };
    ...
    let params2 = CreateStreamParams {
        ...
        start_time: 100,
        cliff_time: 200,
        end_time: 1100, min_withdrawal: 0,
    };
    ...
    let params3 = CreateStreamParams {
        ...
        start_time: 500,
        cliff_time: 500,
        end_time: 1500, min_withdrawal: 0,
    };
...
fn test_create_streams_batch_strict_auth() {
    ...
    let params2 = CreateStreamParams {
        ...
        start_time: 0,
        cliff_time: 0,
        end_time: 2000, min_withdrawal: 0,
    };
...
fn test_create_streams_batch_emits_created_events_with_payloads() {
    ...
    let params1 = CreateStreamParams {
        ...
        start_time: 0,
        cliff_time: 0,
        end_time: 1111, min_withdrawal: 0,
    };
    let params2 = CreateStreamParams {
        recipient: Address::generate(&ctx.env),
        deposit_amount: 2222,
        ...
        start_time: 10,
        cliff_time: 10,
        end_time: 1121, min_withdrawal: 0,
    };
    let streams = vec![&ctx.env, params1.clone(), params2.clone()];
    let events_before = ctx.env.events().all().len();
...
fn test_update_rate_per_second_before_cliff() {
    ...
    let stream_id =
        ctx.client()
            .create_stream(&ctx.sender, &ctx.recipient, &2000, &1, &0, &500, &1000 &0_i128,);
...
fn test_update_rate_per_second_at_cliff() {
    ...
    let stream_id =
        ctx.client()
            .create_stream(&ctx.sender, &ctx.recipient, &5000, &1, &0, &500, &1000 &0_i128,);
...
fn test_extend_end_time_deposit_exactly_covers_new_duration() {
    ...
    // deposit=2000, min_withdrawal: 0, rate=1, start=0, end=1000 → deposit covers up to t=2000
    let stream_id = ctx.client().create_stream(
        &ctx.sender,
        &ctx.recipient,
        &2000_i128,
...
/// Stream cancelled exactly at end_time: full deposit accrued, min_withdrawal: 0, frozen, stays in index.
#[test]
...
/// Stream cancelled past end_time: accrual capped at deposit, min_withdrawal: 0, stays in index.
#[test]
...
fn test_withdraw_from_paused_at_end_time() {
    ...
    let stream_id =
        ctx.client()
            .create_stream(&ctx.sender, &ctx.recipient, &1000, &1, &0, &0, &end_time &0_i128,);
    ...
    let params = soroban_sdk::Vec::from_array(
        ...
        [
            ...
            CreateStreamParams {
                ...
                start_time: 1000,
                cliff_time: 1000,
                end_time: 3000, min_withdrawal: 0,
            },
            CreateStreamParams {
                recipient: recipient1.clone(),
                deposit_amount: 1500,
                ...
                start_time: 1000,
                cliff_time: 1000,
                end_time: 2500, min_withdrawal: 0,
            },
            CreateStreamParams {
                ...
                start_time: 1000,
                cliff_time: 1000,
                end_time: 4000, min_withdrawal: 0,
            },
            CreateStreamParams {
                recipient: recipient2.clone(),
                deposit_amount: 2500,
                ...
                start_time: 1000,
                cliff_time: 1000,
                end_time: 3500, min_withdrawal: 0,
            },
        ],
    );
...
fn test_create_streams_batch_deposit_overflow_is_atomic() {
    ...
    for _ in 0..2 {
        params.push_back(CreateStreamParams {
            ...
            start_time: 0,
            cliff_time: 0,
            end_time: duration, min_withdrawal: 0,
        });
    }
...
mod i128_boundary_streams {
    ...
    fn batch_one_invalid_near_max_entry_rejects_whole_batch() {
        ...
        let valid = CreateStreamParams {
            ...
            start_time: 0,
            cliff_time: 0,
            end_time: 1_000, min_withdrawal: 0,
        };
...
mod recipient_index_stress {
    ...
    fn test_recipient_index_consistency_after_many_removals() {
        ...
        for _ in 0..10 {
            let id = ctx
                .client()
                .create_stream(&ctx.sender, &recipient, &100_i128, &1_i128, &0u64, &0u64, &100u64 &0_i128,);
    ...
    fn test_get_recipient_streams_paginated_respects_max_page_size() {
        ...
        // Create 150 streams
        for _ in 0..150 {
            ctx.client().create_stream(&ctx.sender, &recipient, &100, &1, &0, &0, &100 &0_i128,);
        }
    ...
    fn test_get_recipient_streams_paginated_multiple_recipients() {
        ...
        for _ in 0..5 {
            ctx.client()
                .create_stream(&ctx.sender, &recipient1, &1000_i128, &1_i128, &0u64, &0u64, &1000u64 &0_i128,);
        }

        // Create 3 streams for recipient2
        for _ in 0..3 {
            ctx.client()
                .create_stream(&ctx.sender, &recipient2, &1000_i128, &1_i128, &0u64, &0u64, &1000u64 &0_i128,);
        }
    ...
    fn create_streams_batch_deposit_overflow_returns_structured_error() {
        ...
        let params = soroban_sdk::vec![
            ...
            CreateStreamParams {
                ...
                start_time: 0u64,
                cliff_time: 0u64,
                end_time: half as u64, min_withdrawal: 0,
            },
            CreateStreamParams {
                recipient: ctx.recipient.clone(),
                deposit_amount: half,
